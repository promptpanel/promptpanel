...
ENV DEBIAN_FRONTEND=nointeractive \
    ...
    PROMPT_GOOGLE_CLIENT_ID=DISABLED \
    PROMPT_GOOGLE_CLIENT_SECRET=DISABLED \
    PROMPT_MICROSOFT_CLIENT_ID=DISABLED \
    PROMPT_MICROSOFT_CLIENT_SECRET=DISABLED \
    PROMPT_MICROSOFT_TENANT_ID=DISABLED \
