...
!function () {
  ...
  (x.helper.matchRecursiveRegExp = function (e, r, t, a) {
    ...
    (x.helper.encodeEmailAddress = function (e) {
      ...
      return (e = e.replace(/./g, function (e) {
        var r;
        return (e = "@" === e ? t[Math.floor(2 * Math.random())](e) : 0.9 < (r = Math.random()) ? t[2](e) : 0.45 < r ? t[1](e) : t[0](e));
      }));
    }),
    ...
    (x.Converter = function (e) {
      ...
      n.extensions && x.helper.forEach(n.extensions, c),
        ...
        (this.makeHtml = function (r) {
          ...
          var e,
            t,
            a = { gHtmlBlocks: [], gHtmlMdBlocks: [], gHtmlSpans: [], gUrls: {}, gTitles: {}, gDimensions: {}, gListLevel: 0, hashLinkCounts: {}, langExtensions: i, outputModifiers: l, converter: this, ghCodeBlocks: [], metadata: { parsed: {}, raw: "", format: "" } };
          return (
            (r = (r = (r = (r = (r = r.replace(/¨/g, "¨T")).replace(/\$/g, "¨D")).replace(/\r\n/g, "\n")).replace(/\r/g, "\n")).replace(/\u00A0/g, "&nbsp;")),
            n.smartIndentationFix && ((t = (e = r).match(/^\s*/)[0].length), (t = new RegExp("^\\s{0," + t + "}", "gm")), (r = e.replace(t, ""))),
            (r = "\n\n" + r + "\n\n"),
  ...
  x.subParser("autoLinks", function (e, r, t) {
    ...
    x.subParser("codeSpans", function (e, n, s) {
      "use strict";
      return (
        (e = (e = void 0 === (e = s.converter._dispatch("codeSpans.before", e, n, s)) ? "" : e).replace(/(^|[^\\])(`+)([^\r]*?[^`])\2(?!`)/gm, function (e, r, t, a) {
          ...
          (r = (
            n.ghCompatibleHeaderId
              ? r
                  ...
                  .replace(/[&+$,\/:;=?@"#{}|^¨~\[\]`\\*)(%.!'<>]/g, "")
              : n.rawHeaderId
                ? r.replace(/ /g, "-").replace(/&amp;/g, "&").replace(/¨T/g, "¨").replace(/¨D/g, "$").replace(/["']/g, "-")
                : r.replace(/[^\w]/g, "")
          ).toLowerCase()),
          n.rawPrefixHeaderId && (r = e + r),
    ...
    x.subParser("lists", function (e, d, c) {
      ...
      function p(e, r) {
        ...
        var t = /(\n)?(^ {0,3})([*+-]|\d+[.])[ \t]+((\[(x|X| )?])?[ \t]*[^\r]+?(\n{1,2}))(?=\n*(¨0| {0,3}([*+-]|\d+[.])[ \t]+))/gm,
          l = /\n[ \t]*\n(?!¨0)/.test((e += "¨0"));
        return (
          d.disableForced4SpacesIndentedSublists && (t = /(\n)?(^ {0,3})([*+-]|\d+[.])[ \t]+((\[(x|X| )?])?[ \t]*[^\r]+?(\n{1,2}))(?=\n*(¨0|\2([*+-]|\d+[.])[ \t]+))/gm),
    ...
    x.subParser("metadata", function (e, r, a) {
      "use strict";
      return r.metadata
        ? ((e = (e = (e = (e = a.converter._dispatch("metadata.before", e, r, a)).replace(/^\s*«««+(\S*?)\n([\s\S]+?)\n»»»+\n/, function (e, r, t) {
            return n(t), "¨M";
          })).replace(/^\s*---+(\S*?)\n([\s\S]+?)\n---+\n/, function (e, r, t) {
    ...
    x.subParser("stripLinkDefinitions", function (i, l, c) {
      ...
      function e(e, r, t, a, n, s, o) {
        return (r = r.toLowerCase()), i.toLowerCase().split(r).length - 1 < 2 ? e : (t.match(/^data:.+?\/.+?;base64,/) ? (c.gUrls[r] = t.replace(/\s/g, "")) : (c.gUrls[r] = x.subParser("encodeAmpsAndAngles")(t, l, c)), s ? s + o : (o && (c.gTitles[r] = o.replace(/"|'/g, "&quot;")), l.parseImgDimensions && a && n && (c.gDimensions[r] = { width: a, height: n }), ""));
      }
