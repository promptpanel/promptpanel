...
def chat_stream(message, thread, panel):
    ...
    try:
        ...
        model_selected = settings.get("Model", "gemini-1.5-pro-latest")
        ...
        if model_selected == "Gemini Pro 1.5":
            remaining_tokens = 1000000 - system_message_token_count
        else:
            remaining_tokens = 32000 - system_message_token_count
